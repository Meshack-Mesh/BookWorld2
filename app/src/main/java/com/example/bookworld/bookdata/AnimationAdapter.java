...
public class AnimationAdapter extends RecyclerView.Adapter<AnimationAdapter.BookViewHolder> {

    private List<Book> bookList;
    private OnBookClickListener listener;

    public AnimationAdapter(List<Book> bookList, OnBookClickListener listener) {
